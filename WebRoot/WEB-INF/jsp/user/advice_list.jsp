...
<div data-role="page" id="pageone">
  <div data-role="header">
   <a href="" data-role="button" onclick="javascript:history.back(-1);">主页</a>
    <h1>医生建议列表</h1>
  </div>
  ...
  <div data-role="content">
    ...
    <li><a href="" onclick="window.location.href='advice_info?pId=${advice.p_id }&date=${advice.date }'">${advice.date }</a></li>
    </c:forEach>
  </ul>
  </div>
...
function pageChange(num){
	...
	if(curPage+num<1){
		...
		curPage = curPage+num;
		window.location.href='advice_list?curPage='+curPage;
	}
}
</script>
</html>
